...
class Course(models.Model):
    ...
    department = models.ForeignKey(
        "accounts.Department", on_delete=models.CASCADE, related_name="courses"
    )
...
class CourseFaculty(models.Model):
    ...
    course = models.ForeignKey(
        Course, on_delete=models.CASCADE, related_name="faculty_assignments"
    )
...
class Timetable(models.Model):
    ...
    faculty = models.ForeignKey(
        "accounts.FacultyProfile", on_delete=models.CASCADE, related_name="timetables"
    )
